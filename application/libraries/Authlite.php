...
{
	Kohana::log('debug', 'Authlite Login Method Called');
if (empty($password))
{
	Kohana::log('debug', 'Authlite Password was empty');
return false;
}
...
if ($user->loaded)
{
	Kohana::log('debug', 'Authlite User Loaded');
...
if ($remember == true)
{
Kohana::log('debug', 'Authlite remember = true');
